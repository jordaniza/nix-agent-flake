# Plan Reviewer: ENA Token Analysis

You are reviewing a research plan for the ENA token against the Aragon Ownership Token Framework.
...
3. Read the research plan in `../output/ena-research-plan.md`
...
### Token focus
- Is the plan focused on what the ENA **token** gives its holder, not on Ethena as a company/protocol?
