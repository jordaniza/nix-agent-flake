# Planner: ENA Token Analysis

Your job is to produce `../output/ena-research-plan.md` — a structured research plan for analysing the ENA token against the Aragon Ownership Token Framework.
...
1. State what you're looking for — what question does this metric answer for ENA?
2. Create a longlist of Ethena resources (contracts, repos, docs, governance forums, dashboards)
...
Commit the research plan to `research/ena-research-plan.md` on the `ena` branch. Also write it to `../output/ena-research-plan.md` for the pipeline.

## What the plan must contain

- **Resource inventory**: every Ethena source you've identified (repos, contracts, docs, forums, dashboards) with URLs. Confirm each URL is accessible.
