# Plan Reviewer: ONDO Token Analysis

You are reviewing a research plan for the ONDO token against the Aragon Ownership Token Framework.
...
3. Read the research plan in `../output/ondo-research-plan.md`
...
### Token focus
- Is the plan focused on what the ONDO **token** gives its holder, not on Ondo Finance as a company/protocol?
...
- Does the plan separate ONDO token governance from the OUSG/USDY product layer?
