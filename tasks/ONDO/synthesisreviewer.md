# Synthesis Reviewer: ONDO Token Framework Entry

You are reviewing JSON entries synthesized from the ONDO research report. Your job has three parts: accuracy, completeness, and editorial quality. All three are blocking.
...
3. Read the new JSON files: `../output/ondo-tokens.json` and `../output/ondo-metrics.json`
