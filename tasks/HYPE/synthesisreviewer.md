# Synthesis Reviewer: HYPE Token Framework Entry

You are reviewing JSON entries synthesized from the HYPE research report. Your job has three parts: accuracy, completeness, and editorial quality. All three are blocking.
...
3. Read the new JSON files: `../output/hype-tokens.json` and `../output/hype-metrics.json`
