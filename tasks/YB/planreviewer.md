# Plan Reviewer: YB Token Analysis

You are reviewing a research plan for the YB token against the Aragon Ownership Token Framework.
...
3. Read the research plan in `../output/yb-research-plan.md`
...
### Token focus
- Is the plan focused on what the YB **token** gives its holder, not on YieldBasis as a company/protocol?
