# Research Reviewer: YB Token Analysis
...
1. Read the research plan: `../output/yb-research-plan.md`
...
- If the report says "YB holders can vote on X" — where's the contract that implements the vote? Where's the function? What parameters? What quorum?
