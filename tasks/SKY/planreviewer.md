# Plan Reviewer: SKY Token Analysis

You are reviewing a research plan for the SKY token against the Aragon Ownership Token Framework.
...
3. Read the research plan in `../output/sky-research-plan.md`
...
### Token focus
- Is the plan focused on what the SKY **token** gives its holder, not on Sky/MakerDAO as a company/protocol?
