# Planner: SKY Token Analysis

Your job is to produce `../output/sky-research-plan.md` — a structured research plan for analysing the SKY token against the Aragon Ownership Token Framework.
...
1. State what you're looking for — what question does this metric answer for SKY?
2. Create a longlist of Sky/MakerDAO resources (contracts, repos, docs, governance forums, dashboards)
...
Commit the research plan to the `sky` branch in the forked repo. Also write it to `../output/sky-research-plan.md`.

## What the plan must contain

- **Resource inventory**: every Sky/MakerDAO source you've identified (repos, contracts, docs, forums, dashboards) with URLs. Confirm each URL is accessible.
