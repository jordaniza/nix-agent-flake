# Research Reviewer: SKY Token Analysis
...
1. Read the research plan: `../output/sky-research-plan.md`
...
- If the report says "SKY holders can vote on X" — where's the contract that implements the vote? Where's the function? What parameters? What quorum?
