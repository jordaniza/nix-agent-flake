# Plan Reviewer: SWISE Token Analysis

You are reviewing a research plan for the SWISE token against the Aragon Ownership Token Framework.
...
3. Read the research plan in `../output/swise-research-plan.md`
...
### Token focus
- Is the plan focused on what the SWISE **token** gives its holder, not on Swell as a company/protocol?
