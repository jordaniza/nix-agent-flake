# Researcher: SWISE Token Analysis

Your job is to execute the research plan and produce `../output/swise-research.md` — an exhaustive, fully-sourced research report on the SWISE token against the Aragon Ownership Token Framework.

## How to start

1. Read the research plan in `../output/swise-research-plan.md`
...
You are looking for mechanisms where SWISE tokenholders have **enforceable, on-chain control** that cannot be unilaterally overridden:
...
After each round, commit your updated research report to the `swise` branch in the forked repo. Also write to `../output/swise-research.md`.
