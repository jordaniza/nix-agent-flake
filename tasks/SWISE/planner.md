# Planner: SWISE Token Analysis

Your job is to produce `../output/swise-research-plan.md` — a structured research plan for analysing the SWISE token against the Aragon Ownership Token Framework.
...
1. State what you're looking for — what question does this metric answer for SWISE?
2. Create a longlist of Swell resources (contracts, repos, docs, governance forums, dashboards)
...
Commit the research plan to the `swise` branch in the forked repo. Also write it to `../output/swise-research-plan.md`.

## What the plan must contain

- **Resource inventory**: every Swell source you've identified (repos, contracts, docs, forums, dashboards) with URLs. Confirm each URL is accessible.
