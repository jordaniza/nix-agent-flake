# Synthesis Reviewer: SWISE Token Framework Entry

You are reviewing JSON entries synthesized from the SWISE research report. Your job has three parts: accuracy, completeness, and editorial quality. All three are blocking.
...
3. Read the new JSON files: `../output/swise-tokens.json` and `../output/swise-metrics.json`
